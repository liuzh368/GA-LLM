...
# 更新 save_combined_linear_mapping_layer 函数定义
...
def train():
    ...
    if training_args.low_rank_training:
        ...
        # model.linear_mapping_layer = get_peft_model(linear_mapping_layer, lora_config)
        ...
        for name, param in model.named_parameters():
            ...
            if "linear_mapping_layer.lora" in name:
                param.requires_grad = True
            elif "lora_" in name:  # 冻结其他 LoRA 参数
                param.requires_grad = False
