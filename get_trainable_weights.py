...
def parse_config():
    ...
    parser.add_argument('--checkpoint_path', type=str, default="/home/liuzhao/demo/LLM4POI/outputs/nyc2/llm_stage2_geoencoder_r8_alpha32_without_sim_11_23_20/checkpoint-33066")
