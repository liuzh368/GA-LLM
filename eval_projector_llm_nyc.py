...
def parse_config():
    ...
    parser.add_argument('--data_path', type=str, default="/share/home/liuzh368/demo/LLM4POI/datasets", help='')
    ...
    parser.add_argument('--test_file', type=str, default="test_qa_pairs_kqt_new2_user_poi.txt", help='')
