...
def preprocess(cfg: Cfg):
    ...
    sample_file = osp.join(preprocessed_path, 'sample_min.csv')
    train_file = osp.join(preprocessed_path, 'train_sample_min.csv')
    validate_file = osp.join(preprocessed_path, 'validate_sample_with_traj_min.csv')
    test_file = osp.join(preprocessed_path, 'test_sample_with_traj_min.csv')
