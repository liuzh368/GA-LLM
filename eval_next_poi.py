...
def parse_config():
    ...
    parser.add_argument('--model_path', type=str, default='./model', help='your model path')
    parser.add_argument('--data_path', type=str, default="./dataset", help='')
    parser.add_argument('--output_dir', type=str, default="./output_dir_geo_16384/checkpoint-15000", help='')
    parser.add_argument('--dataset_name', type=str, default="ca", help='')
    parser.add_argument('--test_file', type=str, default="test_qa_pairs_kqt_geo.txt",
                        help='')
